...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto text-center">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12">
            <!-- Course Card 1 -->
            <div class="bg-white rounded-xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105 p-6 border border-gray-200 hover:border-green-400" data-aos="fade-up" data-aos-delay="300">
                <img src="assets/img.webp" alt="Course Image" class="w-full h-56 object-cover rounded-lg mb-6 transition-transform duration-500 hover:scale-105">
                ...
                <div class="mt-6 flex justify-between space-x-4">
                    <a href="/course/1" class="bg-gradient-to-r from-indigo-500 to-blue-600 hover:from-indigo-600 hover:to-blue-700 text-white py-3 px-8 rounded-full text-lg inline-block transition-all duration-300 ease-in-out w-full sm:w-auto">View Course</a>
                    <a href="/course/3" class="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white py-3 px-8 rounded-full text-lg inline-block transition-all duration-300 ease-in-out w-full sm:w-auto">Buy Course</a>

                </div>
            </div>

            <!-- Course Card 2 -->
            <div class="bg-white rounded-xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105 p-6 border border-gray-200 hover:border-green-400" data-aos="fade-up" data-aos-delay="400">
                <img src="assets/img.webp" alt="Course Image" class="w-full h-56 object-cover rounded-lg mb-6 transition-transform duration-500 hover:scale-105">
                ...
                <!-- Buttons Section (Side by Side) -->
                <div class="mt-6 flex justify-between space-x-4">
                    <a href="/course/2" class="bg-gradient-to-r from-indigo-500 to-blue-600 hover:from-indigo-600 hover:to-blue-700 text-white py-3 px-8 rounded-full text-lg inline-block transition-all duration-300 ease-in-out w-full sm:w-auto">View Course</a>
                    <a href="/course/3" class="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white py-3 px-8 rounded-full text-lg inline-block transition-all duration-300 ease-in-out w-full sm:w-auto">Buy Course</a>
            ...
            <!-- Course Card 3 -->
            <div class="bg-white rounded-xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:scale-105 p-6 border border-gray-200 hover:border-green-400" data-aos="fade-up" data-aos-delay="500">
                <img src="assets/img.webp" alt="Course Image" class="w-full h-56 object-cover rounded-lg mb-6 transition-transform duration-500 hover:scale-105">
                ...
                <!-- Buttons Section (Side by Side) -->
                <div class="mt-6 flex justify-between space-x-4">
                    <a href="/course/3" class="bg-gradient-to-r from-indigo-500 to-blue-600 hover:from-indigo-600 hover:to-blue-700 text-white py-3 px-8 rounded-full text-lg inline-block transition-all duration-300 ease-in-out w-full sm:w-auto">View Course</a>
                    <a href="/course/3" class="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white py-3 px-8 rounded-full text-lg inline-block transition-all duration-300 ease-in-out w-full sm:w-auto">Buy Course</a>
        ...
        <section class="py-16 bg-white" id="free-courses">
        <div class="container mx-auto text-center">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12">
                ...
                <div class="bg-gray-100 rounded-xl shadow-md hover:shadow-lg transition-all duration-500 transform hover:scale-105 p-6 border border-gray-200" data-aos="fade-up" data-aos-delay="300">
                    <img src="Clarity/assets/logo.svg" alt="Free Course Image" class="w-full h-56  rounded-lg mb-6 transition-transform duration-500 hover:scale-105">
                    <h3 class="text-2xl font-semibold text-gray-800 hover:text-green-500 transition-colors duration-300">Clarity Basics</h3>
                    <!-- <p class="text-lg text-gray-600 mt-2">Instructor: Nirajan Sharma</p>
                    <p class="text-lg text-gray-600">5hrs</p> -->
                ...
                <div class="bg-gray-100 rounded-xl shadow-md hover:shadow-lg transition-all duration-500 transform hover:scale-105 p-6 border border-gray-200" data-aos="fade-up" data-aos-delay="400">
                    <!-- <img src="assets/free-course2.webp" alt="Free Course Image" class="w-full h-56 object-cover rounded-lg mb-6 transition-transform duration-500 hover:scale-105"> -->
                    <h3 class="text-2xl font-semibold text-gray-800 hover:text-green-500 transition-colors duration-300">Basics of Smart Contracts</h3>
                    <p class="text-lg text-gray-600 mt-2">Instructor: Anisha Singh</p>
                    <p class="text-lg text-gray-600">6hrs 45min</p>
                    <p class="text-xl font-bold text-green-600 mt-4">Free</p>
                ...
                <!-- Free Course Card 3 -->
                <div class="bg-gray-100 rounded-xl shadow-md hover:shadow-lg transition-all duration-500 transform hover:scale-105 p-6 border border-gray-200" data-aos="fade-up" data-aos-delay="500">
                    <!-- <img src="assets/free-course3.webp" alt="Free Course Image" class="w-full h-56 object-cover rounded-lg mb-6 transition-transform duration-500 hover:scale-105"> -->
                    <h3 class="text-2xl font-semibold text-gray-800 hover:text-green-500 transition-colors duration-300">Ethereum Fundamentals</h3>
                    <p class="text-lg text-gray-600 mt-2">Instructor: Keshav Gautam</p>
                    <p class="text-lg text-gray-600">4hrs 30min</p>
                    <p class="text-xl font-bold text-green-600 mt-4">Free</p>
                    
                    <div class="mt-6">
                        <a href="/free-course/3" class="bg-green-600 hover:bg-green-700 text-white py-3 px-8 rounded-full text-lg inline-block transition-all duration-300 ease-in-out">Enroll Now</a>
                    </div>
                </div>
            </div>
        </div>
