...
<body class="flex flex-col min-h-screen bg-green-100">
    ...
    <main class="flex-grow">
        ...
        $allowedPages = ['home','buy-token', 'myLearnings', 'buy-course', 'solidity-basic', 'live-class', 'cart','about', 'courses' , 'help', 'Solidity-Disc', 'Solidity-Course','userregister-form','Clarity_course','learnmore'];
