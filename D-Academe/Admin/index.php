...
<body class="flex flex-col min-h-screen bg-green-100">
    ...
    <main class="flex-grow">
        ...
        $allowedPages = ['home','solidity-basic', 'live-class','about','courses','addcourse', 'view_profile', 'help', 'Solidity-Disc', 'Solidity-Course','userregister','Clarity_course']; // Add allowed pages here
