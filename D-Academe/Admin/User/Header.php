...
<!-- Logo -->
    ...
    <button id="loginButton" 
            class="bg-blue-600 text-white py-2 px-4 rounded-full hover:bg-blue-700 transition-colors duration-200 shadow-md hover:shadow-lg" 
            onclick="login()">Login
    </button>

    <!-- Wallet Button (Initially Hidden) -->
    <button id="walletButton" 
            class="bg-green-600 text-white py-2 px-4 rounded-full hover:bg-green-700 transition-colors duration-200 shadow-md hover:shadow-lg hidden" 
            onclick="toggleWallet()">Connect Wallet
    </button>

    <!-- Profile Section (Initially Hidden) -->
    <div id="profileSection" class="hidden relative">
        <button class="bg-gray-600 text-white py-2 px-4 rounded-full hover:bg-gray-700 transition-colors duration-200 shadow-md hover:shadow-lg flex items-center gap-2" 
        ...
        <div id="dropdownMenu" class="absolute right-0 mt-2 w-48 bg-gray-800 text-white rounded-md shadow-lg hidden">
            <ul>
                <li><button class="w-full text-left px-4 py-2 hover:bg-gray-700 transition-colors duration-200" onclick="showUserInfo()">User Info</button></li>
                <li><button class="w-full text-left px-4 py-2 hover:bg-gray-700 transition-colors duration-200" onclick="viewProfile()">View Profile</button></li>
                <li><button class="w-full text-left px-4 py-2 hover:bg-gray-700 transition-colors duration-200" onclick="logout()">Sign Out</button></li>
            </ul>
        </div>
    </div>
</div>
...
<script>
    ...
    function logout() {
        ...
        toggleDropdown(false); // Ensure dropdown is hidden on logout
    }

    function showUserInfo() {
        alert("Displaying user info...");
        // Replace with actual logic to fetch and display user info
    }
    ...
    function toggleDropdown(forceHide = null) {
